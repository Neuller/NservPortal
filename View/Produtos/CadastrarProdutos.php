                ...
                <form id="frmProdutos">
                    <div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4 itensFormulario">
                            <div>
                                <label>CÓDIGO</label>
                                <input type="text" class="form-control input-sm codigo text-uppercase" id="codigo"
                                    name="codigo" maxlenght="10">
                            </div>
                        </div>
                        <!-- DESCRIÇÃO -->
                        <div class="col-md-12 col-sm-12 col-xs-12 itensFormulario">
                            <div>
                                ...
                                <textarea type="text" class="form-control input-sm text-uppercase" id="descricao"
                                    name="descricao" maxlength="1000" rows="3" style="resize: none"></textarea>
                            </div>
                        </div>
                        <!-- GARANTIA -->
                        <div class="col-md-8 col-sm-8 col-xs-8 itensFormulario">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4 itensFormulario">
                            <div>
                                <label>ESTOQUE</label>
                                <input type="number" class="form-control input-sm estoque text-uppercase" id="estoque"
                                    name="estoque" maxlenght="10">
                            </div>
                        </div>
                        <!-- VALOR UNIDADE -->
                        <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
                            <div>
                                ...
                                <input type="number" class="form-control input-sm text-uppercase" id="preco"
                                    name="preco" maxlenght="10">
                            </div>
                        </div>
                        <!-- VALOR INSTALADO -->
                        <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
                            <div>
                                ...
                                <input type="number" class="form-control input-sm text-uppercase" id="precoInstalacao"
                                    name="precoInstalacao" maxlenght="10">
                            </div>
                        </div>
                        <!-- NF -->
                        <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
                            <div>
                                ...
                                <input type="text" class="form-control nf input-sm text-uppercase" id="nf" name="nf"
                                    maxlenght="10">
                            </div>
                        </div>
                        <!-- NCM -->
                        <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
                            <div>
                                <label>NCM</label>
                                <input type="text" class="form-control ncm input-sm text-uppercase" id="ncm" name="ncm"
                                    maxlenght="10">
                            </div>
                        </div>
                        <!-- BOTÂO CADASTRAR -->
