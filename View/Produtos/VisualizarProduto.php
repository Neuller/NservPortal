                ...
                <div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4 itensFormulario">
                        <div>
                            ...
                            <input type="text" readonly class="form-control input-sm codigo text-uppercase" id="codigoU"
                                name="codigoU" maxlenght="10">
                        </div>
                    </div>
                    <!-- DESCRIÇÃO -->
                    <div class="col-md-12 col-sm-12 col-xs-12 itensFormulario">
                        <div>
                            ...
                            <textarea type="text" class="form-control input-sm text-uppercase" id="descricaoU"
                                name="descricaoU" maxlength="100" rows="3" style="resize: none"></textarea>
                        </div>
                    </div>
                    <!-- GARANTIA -->
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4 itensFormulario">
                        <div>
                            ...
                            <input type="text" class="form-control input-sm estoque text-uppercase" id="estoqueU"
                                name="estoqueU" maxlenght="10">
                        </div>
                    </div>
                    <!-- VALOR UNIDADE -->
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
                        <div>
                            ...
                            <input type="text" class="form-control input-sm text-uppercase" id="precoInstalacaoU"
                                name="precoInstalacaoU" maxlenght="10">
                        </div>
                    </div>
                    <!-- NF -->
                    <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
                        <div>
                            ...
                            <input type="text" class="form-control nf input-sm text-uppercase" id="nfU" name="nfU"
                                maxlenght="10">
                        </div>
                    </div>
                    <!-- NCM -->
                    <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
                        <div>
                            <label>NCM</label>
                            <input type="text" class="form-control ncm input-sm text-uppercase" id="ncmU" name="ncmU"
                                maxlenght="10">
                        </div>
                    </div>
                    <!-- BOTÕES -->
...
$("#btnSalvar").click(function() {
    ...
    $.ajax({
        type: "POST",
        data: dados,
        url: "./Controller/Produtos/EditarProdutos.php",
        success: function(r) {
            debugger;
            if (r == 1) {
...
function carregarDados(id) {
    $.ajax({
        type: "POST",
        data: "idProduto=" + id,
        url: "./Controller/Produtos/ObterDadosProdutos.php",
        success: function(r) {
