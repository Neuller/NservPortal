				...
				<div class="mx-auto">
					<form id="frmVendas">
                        ...
                        <div class="col-xs-4 col-md-4 col-sm-4 itensFormulario">
                            <div>
                                <label>TOTAL</label>
                                <input readonly type="number" class="form-control input-sm text-uppercase" id="total" name="total" maxlenght="10">
                            </div>
                        </div>
                        <!-- VALOR DO PAGAMENTO -->
                        ...
                        <div class="col-xs-6 col-md-6 col-sm-6 itensFormulario saldoDevedor">
                            <div>
                                ...
                                <input readonly type="number" class="form-control input-sm text-uppercase" id="saldoDevedor" name="saldoDevedor" maxlenght="10">
                            </div>
                        </div>
                        <!-- VALOR TOTAL -->
                        <div class="col-xs-6 col-md-6 col-sm-6 itensFormulario">
                            <div>
                                ...
                                <input readonly type="number" class="form-control input-sm text-uppercase" id="valorTotal" name="valorTotal" maxlenght="10">
                            </div>
                        </div>
                        <!-- OBSERVAÇÕES -->
                        <div class="col-md-12 col-sm-12 col-xs-12 separador">
