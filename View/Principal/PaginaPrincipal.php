...
<html>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#tabelaServicosMes").load("./View/Principal/tabelaServicosMes.php");
			$("#tabelaVendasMes").load("./View/Principal/tabelaVendasMes.php");
			moment.locale("pt-br");
		...
		// 	$("#conteudo").load("./View/Servicos/EditarServicos.php?id=" + idServico);
		// }
		...
		function getDadosUsuarioLogado() {
			$.ajax({
				type: "POST",
				url: "./Controller/Usuarios/ObterDadosUsuario.php",
				success: function(r) {
					retorno = $.parseJSON(r);
