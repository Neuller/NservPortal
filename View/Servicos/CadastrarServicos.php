...
?>
    ...
    <script type="text/javascript">
        ...
        function setEvents() {
            $("#btnCadastrar").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: dados,
                    url: "./Controller/Servicos/CadastrarServicos.php",
                    success: function(r) {
                        if (r > 0) {
                            ...
                            alertify.confirm("ATENÇÃO", "DESEJA IMPRIMIR ORDEM DE SERVIÇO?", function() {
                                ...
                                window.open("./Controller/Servicos/OrdemServico/CriarOrdemServicoEntrada.php?idServ=" + id);
        ...
        function gerarNovaOrdem() {
            $.ajax({
                url: "./Controller/Servicos/GerarNovaOrdem.php",
                success: function(r) {
                    if (r >= 1) {
                        $("#ordem").val(r);
                    }
