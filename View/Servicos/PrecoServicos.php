...
<script type="text/javascript">
	$(document).ready(function() {
		$("#tabelaPrecos").load("./View/Servicos/TabelaPrecos.php");
	});
	
	$("#btnNovo").click(function() {
		$("#conteudo").load("./View/Servicos/CadastrarPrecoServicos.php");
	});
	...
	function excluir(id) {
		alertify.confirm("ATENÇÃO", "DESEJA EXCLUIR O REGISTRO?", function() {
			$.ajax({
				type: "POST",
				data: "id=" + id,
				url: "./Controller/Servicos/ExcluirPrecoServicos.php",
				success: function(r) {
					if (r == 1) {
						$("#tabelaPrecos").load("./View/Servicos/TabelaPrecos.php");
