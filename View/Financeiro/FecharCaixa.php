				...
				<div class="mx-auto">
					<form id="frmContabilizarNotas">   
                        <div class='col-md-12 col-sm-12 col-xs-12'>
                            ...
                            <hr>
                            <div class="text-left itensFormulario">
								<ul>
                                    <li>INFORME A QUANTIDADE DE NOTAS</li>
                                </ul>
							</div>
						</div>
                        <!-- NOTA DE DOIS REAIS -->
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 itensFormulario">
                            <div>
                                <label class="col-md-12 col-sm-12 col-xs-12">TOTAL</label>
                    ...
                    <form id="frmContabilizarMoedas">   
                        <div class='col-md-12 col-sm-12 col-xs-12'>
                            ...
                            <div class="text-left itensFormulario">
								<ul>
                                    <li>INFORME A QUANTIDADE DE MOEDAS</li>
                                </ul>
							</div>
						</div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <article>
                                ...
                                <div class="text-center textCabecalho opacidade">
                                    <span>VINTE E CINCO CENTAVOS</span>
                                </div>
                                <div class="text-center itensFormulario">
                                    <section>
                                        <div class="text-center">
                    ...
                    <form id="frmConfirmarDados">   
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
							<div>
								<label>XEROX/IMPRESSÕES</label>
								<input type="number" class="form-control input-sm align text-uppercase" id="xeroxImp" name="xeroxImp">
							</div>
						</div>
                        <!-- ACESSOS -->
                        <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
							<div>
								<label>ACESSOS</label>
								<input type="number" class="form-control input-sm align text-uppercase" id="acessos" name="acessos">
							</div>
						</div>
                        <!-- RETIRADA -->
                        <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
							<div>
								<label>RETIRADA<span class="required">*</span></label>
								<input type="number" class="form-control input-sm align text-uppercase" id="retirada" name="retirada">
							</div>
						</div>
                        <!-- VALOR TOTAL -->
                        <div class="col-md-6 col-sm-6 col-xs-6 itensFormulario">
							<div>
								...
								<input type="number" readonly class="form-control input-sm align text-uppercase" id="totalCaixaFinal" name="totalCaixaFinal">
							</div>
						</div>
                        <!-- BOTÕES -->
                        <div class="col-md-12 col-sm-12 col-xs-12 cabecalho bgGray">
...
<script type="text/javascript">
    ...
    $('#btnFecharCaixa').click(function() {	
        ...
        $.ajax({
		    type: "POST",
		 	data: dados,
		 	url: "./Controller/Financeiro/FecharCaixa.php",
		 	success: function(r) {
                 if(r > 0){
    ...
    $('#retirada').change(function() {
        var caixaFinal = $("#caixaFinal").val();
        var retirada = $("#retirada").val();
        var valorTotal = parseFloat(caixaFinal) - parseFloat(retirada);
        if (retirada > caixaFinal){
            alertify.error("VALOR INVÁLIDO");
            $("#retirada").val("");
            return false;
        }else{
            $("#totalCaixaFinal").val(valorTotal.toFixed(2));
        }
    });
