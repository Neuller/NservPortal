...
?>
    ...
    <script type="text/javascript">
        ...
        function initForm() {
            ...
            $("#referencia").val(data);
            $('#tblTitulos').load('./View/Financeiro/ContasAPagar/tblTitulos.php');
        }
        ...
        function setEvents() {
            $("#btnCadastrar").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: dados,
                    url: "./Controller/Financeiro/ContasAPagar/ContasAPagar.php",
                    success: function(r) {
                        if (r > 0) {
        ...
        function excluirTitulo(idTitulo) {
            alertify.confirm('ATENÇÃO', 'DESEJA EXCLUIR O TÍTULO?', function() {
                $.ajax({
                    ...
                    url: "./Controller/Financeiro/ContasAPagar/ExcluirTitulo.php",
                    success: function(r) {
                        if (r == 1) {
                            $('#tblTitulos').load("./View/Financeiro/ContasAPagar/tblTitulos.php");
        ...
        function atualizarTitulo(idTitulo) {
            $('#conteudo').load("./View/Financeiro/AtualizarTitulos.php?id=" + idTitulo);
        }
    </script>
<?php
} else {
