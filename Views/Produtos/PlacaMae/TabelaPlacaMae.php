...
<body>
	<div class="table-responsive">
		<table id="tabelaPlacaMaeLoad" class="table table-hover table-condensed table-bordered text-center table-striped">
			<!-- CABEÇALHO -->
			<thead>
				<tr>
					<td>CÓDIGO</td>
