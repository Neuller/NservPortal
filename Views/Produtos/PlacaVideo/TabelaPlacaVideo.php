...
FROM produtos
WHERE categoria = 'PLACA DE VIDEO'
...
<body>
	<div class="table-responsive">
		<table id="tabelaPlacaVideoLoad" class="table table-hover table-condensed table-bordered text-center table-striped">
			<!-- CABEÇALHO -->
			<thead>
				<tr>
					<td>CÓDIGO</td>
...
<script>
	$(document).ready(function() {
		$('#tabelaPlacaVideoLoad').DataTable(
			{
				"language": {
