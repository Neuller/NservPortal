...
<body>
	<div class="table-responsive">
		<table id="tabelaImpressoraLoad" class="table table-hover table-condensed table-bordered text-center table-striped">
			<!-- CABEÇALHO -->
			<thead>
				<tr>
					<td>CÓDIGO</td>
...
<script>
	$(document).ready(function() {
		$('#tabelaImpressoraLoad').DataTable(
			{
				"language": {
