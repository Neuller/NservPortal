...
public function CadastrarProdutos($dados){
	...
	$sql = "INSERT INTO produtos (categoria, codigo, descricao, garantia, preco, preco_instalacao, estoque, nf, ncm, data_cadastro, status) 
	VALUES ('$dados[1]','$dados[0]', '$dados[2]','$dados[3]', '$dados[5]', '$dados[6]', '$dados[4]', '$dados[7]', '$dados[8]', '$data', 'ATIVO')";
...
/** INATIVAR PRODUTO */
public function inativarProduto($dados){
	$c = new conectar();
	$conexao = $c -> conexao();
